...
## Summary
Parker updated deploy-kimi-k25.sh for existing Azure AI Foundry account, added LLM_PROVIDER=openai to K8s worker deployments, and flagged AU East vs US region discrepancy.  
Ripley added Azure OpenAI path to API's _call_llm(), wired AZURE_OPENAI_* env vars to K8s deployments, bumped API version, and verified worker llm_client.py compatibility.
