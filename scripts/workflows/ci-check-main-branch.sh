#!/bin/bash
# =============================================================================
# Check if current ref is master branch
# =============================================================================
# Used by: .github/workflows/ci.yml (detect-changes job, line 83)
# Purpose: Determine if workflow is running on master branch for full validation
#
# Outputs:
...
#   - github.event_name == 'push' AND github.ref_name == 'master'
#
...
if [[ "${{ github.ref }}" == "refs/heads/master" ]] || [[ "${{ github.event_name }}" == "push" && "${{ github.ref_name }}" == "master" ]]; then
