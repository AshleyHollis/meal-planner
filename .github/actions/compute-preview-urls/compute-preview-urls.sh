#!/bin/bash
################################################################################
# Action: compute-preview-urls / compute-preview-urls.sh
#
# Purpose: Computes preview environment URLs based on PR number
#
# Inputs (Environment Variables):
#   PR_NUMBER   - Pull request number
#   APP_NAME    - Application name (default: meal-planner)
...
PR_NUMBER="${PR_NUMBER:-}"
APP_NAME="${APP_NAME:-meal-planner}"
...
# Compute URLs
################################################################################
echo "[INFO] ⏳ Computing preview environment URLs..."

# New URL scheme uses Gateway API with wildcard DNS
# Format: api-pr-{number}.{base-domain}
# Example: api-pr-123.meal-planner.apps.ashleyhollis.com
...
TLS_SECRET="meal-planner-wildcard-tls"
...
echo "[INFO] ✓ Preview URLs computed successfully"
echo ""
