...
const KEYWORD_MAP: Record<string, string> = {
  chicken: "chicken", poultry: "chicken", thigh: "chicken", breast: "chicken", wing: "chicken",
  beef: "beef", steak: "steak", mince: "beef", roast: "roast",
  pasta: "pasta", spaghetti: "pasta", penne: "pasta", lasagna: "pasta", noodle: "pasta",
  fish: "fish", salmon: "salmon", tuna: "fish", cod: "fish", prawn: "seafood", shrimp: "seafood",
  salad: "salad", lettuce: "salad", caesar: "salad",
  soup: "soup", broth: "soup", chowder: "soup",
  rice: "rice", risotto: "rice", fried_rice: "rice",
  vegetable: "vegetable", vegan: "vegetable", veggie: "vegetable",
  pizza: "pizza",
  sandwich: "sandwich", wrap: "sandwich", sub: "sandwich",
  curry: "curry", thai: "curry", indian: "curry", masala: "curry",
  stirfry: "stirfry", stir: "stirfry", wok: "stirfry",
  burger: "burger", hamburger: "burger",
  taco: "tacos", burrito: "tacos", mexican: "tacos",
  pancake: "breakfast", egg: "breakfast", toast: "breakfast",
  cake: "dessert", sweet: "dessert", brownie: "dessert", cookie: "dessert",
};
...
export function getMealImageUrl(mealName: string, width = 800, height = 600): string {
